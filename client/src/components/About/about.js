...
function About () {
    return(
        ...
        <div className="About-me">
            ...
            <p>This website has no administrators or monitors. The community of users will monitor itself. If you find something offensive, unconstructive, or just mean, downvote it. Once a comment’s or post’s downvote make up 60% of its overall likes and dislikes, poof! It’s gone. This is to eliminate the possibility of a noisy few distorting how the majority actually feel on a topic. We give the power back to the people and have faith that the majority will more accurately express a narrative that is representative of the general public. Socrates™ is an experiment in digital democracy. </p>
            <p>Socrates famously said, “True knowledge exists knowing that you know nothing”. Every human is thrown into this world of randomness and all try to make sense of it with our ideas. We promote the philosophy that humans should not be married to their ideas and it’s ok to change your mind. Changing your mind is not an admission of error if you were never claiming to be correct to begin with. We hope this website promotes healthy, civil debate that will lead to personal growth and a better understanding of the opposition.</p>
        </div>
        </>
    )
}
